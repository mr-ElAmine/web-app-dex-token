...
class HttpError implements HttpErrorInterface {
  ...
  error(
    ...
    const messageForStatusCode = HttpError.messages[statusCode] || 'Internal Server Error';
    return { statusCode, message: messageForStatusCode };
  }
...
export const ApiErrorInstance = new HttpError();
